...
import com.tailoredshapes.dementor.QuestionDelegate;
...
public class QuestionHandler implements RequestHandler<SQSEvent, SQSBatchResponse> {
    ...
    public QuestionHandler() {
        ...
        questionDelegate = new QuestionDelegate(repo, sqsMessageSender, topic, bot);
    }
    ...
    public SQSBatchResponse handleRequest(SQSEvent event, Context context) {
        ...
        event.getRecords().forEach((record) -> {
            ...
            var success = questionDelegate.handle(chatId);
            if(!success){
